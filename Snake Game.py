...
green = pygame.Color(0, 0,255)  # snake

black = pygame.Color(0, 0, 0)  # score

white = pygame.Color(255, 255, 255)  # background

blue = pygame.Color(0, 255,0)  # food
...
pSurf = pfont.render('Welcome to Snake Game created by Thimmarayan M.', True, blue) # add your name here
...
def gameOver():
    ...
    GOsurf = gFont.render('Game over!& out', True, red)
